...
public class NotificationReworkController implements NotificationReworkApi {
    ...
    @Override
    public Mono<ResponseEntity<SequenceResponse>> notificationRework(String statusCode, String deliveryFailureCause, final ServerWebExchange exchange) {
        return notificationReworkService.notificationRework(statusCode, deliveryFailureCause)
