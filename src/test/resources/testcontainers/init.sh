...
queues="pn-ocr_outputs dl-sqs pn-external_channel_to_paper_tracker pn-external_channel_outputs pn-external_channel_to_paper_channel_dryrun pn-external_channel_to_paper_channel pn-paper_tracker_errors"
