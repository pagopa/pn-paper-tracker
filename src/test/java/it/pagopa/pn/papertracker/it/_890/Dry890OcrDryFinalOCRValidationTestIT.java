...
@SpringBootTest
@TestPropertySource(
        locations = "classpath:application.test-ocr-dry.properties",
        properties = {
                "pn.paper-tracker.send-ocr-attachments-final-validation-stock890=1970-01-01;ARCAD"
        }
)
public class Dry890OcrDryFinalOCRValidationTestIT extends Abstract890TestIT {
    ...
    void runScenario(String fileName, ProductTestCase scenario) throws InterruptedException {
        try {
            ...
            scenarioRunner.run(scenario, OcrStatusEnum.DRY, false);
