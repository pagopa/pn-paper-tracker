...
@TestPropertySource(
        ...
        properties = {
                "pn.paper-tracker.enable-ocr-validation-for=1970-01-01;AR:RUN;890:RUN;RS:RUN"
        }
)
public class DryRSOcrRunTestIT extends AbstractRSTestIT {
