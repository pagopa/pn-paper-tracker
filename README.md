...
* **AsyncAPI**: [paper-tracker-errors-v1.yaml](docs/asyncapi/paper-tracker-errors-v1.yaml)
...
| PN_PAPERTRACKER_TOPICS_PAPERTRACKERERRORSQUEUE                                                                                                                                            | ENV      | -      | Nome della coda SQS su cui pubblicare gli errori di tracciamento                         |
