...
| API   | IN  | pn-paper-tracker                            | REST        | GET     | /paper-tracker-private/v1/attemptsById/{attemptId}                      | Recupero tracking tramite attemptId                    |
...
| EVENT | IN  | pn-external_channell_to_paper_channel       | SQS         | CONSUME | -                                                                       | Ricezione eventi dal consolidatore                     |
